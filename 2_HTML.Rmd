...
Before we dive into web scraping, we cover some of the HTML basics. You only need a rudimentary understanding of HTML to scrape data from the web, but the more you know, the better you get at troubleshooting errors, working with exemptions, and writing more flexible and robust solutions. 
...
Web pages have a head and a body. HTML documents consist of a tree of elements and text. Most often, we are interested in what is inside the **body**, that is, the substantial content of a web page.
...
Hyperlinks are common elements on websites: Linking to other websites is one of the core features of the world wide web. Text content is turned into a link with the `<a>` tag (*anchor*), and the link address is specified as `href` attribute (*hyper-reference*).
...
- Universal selector
  - Using the asterisk, `*`, selects all tags; it matches everything. 
- Attribute selector
